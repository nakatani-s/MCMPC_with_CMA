...
__constant__ float d_param[dim_param], d_constraints[NUM_CONST], d_matrix[dim_weight_matrix], d_hat_Q[dim_hat_Q];
__shared__ float W_comp[THREAD_PER_BLOCKS], L_comp[THREAD_PER_BLOCKS];
